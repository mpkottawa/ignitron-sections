...
const float VOLTAGE_DIVIDER_R2 = (10 * 1000);  // 10 kohm

#if BATTERY_TYPE == BATTERY_TYPE_LI_ION
const float BATTERY_CAPACITY_VOLTAGE_THRESHOLD_90 = (BATTERY_CELLS * 3.5);
const float BATTERY_CAPACITY_VOLTAGE_THRESHOLD_50 = (BATTERY_CELLS * 3.1);
const float BATTERY_CAPACITY_VOLTAGE_THRESHOLD_10 = (BATTERY_CELLS * 2.8);
